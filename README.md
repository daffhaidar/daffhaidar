...
[![Portfolio](https://img.shields.io/badge/-Portfolio-6366F1?style=flat&logo=vercel&logoColor=white)](https://haidarwrite.vercel.app)
...
- ☁️ **Infrastructure** — Cloud infra for blockchain nodes at scale (AWS, Oracle Cloud, DigitalOcean)
- 🔗 **Building** — Smart contracts, dApps, DeFi tools — shipping prototypes and getting things live

### Tools I Work With

Solidity · Azure · JavaScript/TypeScript · Python · Go · React · Next.js · Tailwind · Docker · Linux · Nginx · AWS · Oracle Cloud · Alibaba Cloud
